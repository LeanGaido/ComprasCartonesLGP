...
namespace ComprasCartonesLGP.Entities.Pago360.Request
{
    public class CardDebitRequest
    {
        ...
        public Metadata metadata { get; set; }//metadata Object  NO Objeto JSON que se puede utilizar para guardar atributos adicionales en la Solicitud de Débito y poder sincronizar con tus sistemas de backend.Pagos360.com no utiliza este objeto.
    }
}
