...
namespace ComprasCartonesLGP.Entities.Pago360.Response
{
    ...
    {
        public int id { get; set; }//id Integer ID de la Solicitud de Débito en Tarjeta.
        public string type { get; set; }//type    String Tipo de Solicitud.
        public string state { get; set; }//state String  Estado de la Solicitud de Débito en Tarjeta. .
        ...
        //public object metadata { get; set; }//metadata    Object Objeto JSON que se puede utilizar para guardar atributos adicionales en la Solicitud de Débito y poder sincronizar con tus sistemas de backend. Pagos360.com no utiliza este objeto.
        public AdhesionCard card_adhesion { get; set; }//card_adhesion Object  Objeto con el detalle de la Adhesión en Tarjeta.
    }
}
